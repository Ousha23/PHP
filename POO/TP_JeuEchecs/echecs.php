<?php
    ...
    echo "cas (2,7) F: ";
    echo ($p1->peutAllerA(4,7))? DEPLACER.RC.RC: NEDEPLACER.RC.RC;
    echo "cas (1,7) F: ";
    ...
    echo "cas (8,1) F: ";
    echo ($p2->peutAllerA(1,8))? DEPLACER.RC.RC: NEDEPLACER.RC.RC;
    echo "cas (7,3) F: ";
    echo ($p2->peutAllerA(0,7))? DEPLACER.RC.RC: NEDEPLACER.RC.RC;
